...
"""
#Я примерно понял как делать, нужно подстановкой сделать, поставить спереди %s 0. Я так понимаю нужно сделать дополнительные условия, вроде того если цифра дня или месяца меньше 10 то сделать так, а в ином случае оставить так.